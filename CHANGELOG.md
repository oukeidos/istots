...
- Clarifies broken Gemini credential settings in command-line checks and Gemini-assisted runs, and stops workflow checks before starting work that is already blocked.
