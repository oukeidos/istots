...
- Post-plan detector add-on expansion: added an opt-in dominant-family recall layer that can attach directly to the default detector surface without enabling the wider detector mode.
